...
export default function ProductList() {
  ...
  useEffect(() => {
    dispatch(fetchProductsBySearchAsync());
  }, [dispatch]);
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="bg-white">
        <div className="sm:grid sm:grid-cols-3 ">
          <h1 className="text-3xl font-bold tracking-tight text-gray-900 mb-4 sm:p-6 sm:mb-0">
            LaraBackPro
          </h1>
          <form
            className="max-w-md   sm:col-span-2 sm:p-6"
            onSubmit={(e) => {
              e.preventDefault();
            }}
          >
        ...
        <div>
          ...
          ></MobileFilter>
          <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-10 sm:pt-0">
        ...
        <div className="mt-6 grid grid-cols-1 gap-x -6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
          ...
          {products.map((product) => (
            <Link to={`/product-detail/${product.id}`} key={product.id}>
              <div className="group relative border-2 p-2 border-solid border-gray-200">
